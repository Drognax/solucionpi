<?php $__env->startSection('ruta', 'Instalaciones de '.$first->nombre); ?>
...
<div class="card-content collapse show">
	<div class="table-responsive">
		<table id="tablet" class="table table-hover table-fixed table-bordered table-sm">
			...
			<tbody id="myTable">
				<?php $__empty_1 = true; $__currentLoopData = $plant; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $local): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
				<tr>
          ...
          <button type="button" class="btn btn-icon btn-dark btn-sm"><i class="la la-plus"></i></button>
					...
					<td><?php echo e($local->direccion); ?></td>
					<td><?php echo e($local->area); ?></td>
					<td><?php echo e($local->actividades); ?></td>
					<td></td>
					<td></td>
					<td></td>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\enlace\resources\views/dashboard/dashlocal.blade.php ENDPATH**/ ?>