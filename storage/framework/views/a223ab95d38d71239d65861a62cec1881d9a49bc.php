		...
		<table id="tablet" class="table table-hover table-fixed table-bordered table-sm">
          ...
          <button type="button" class="btn btn-icon btn-dark btn-sm"><i class="la la-plus"></i></button>
					...
					<td></td>
			    		...
			    		<?php if($row->trabajador_id == $trabajador->id): ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\enlace\resources\views/dashboard/dashtrabajadores.blade.php ENDPATH**/ ?>