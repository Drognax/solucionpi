<?php $__currentLoopData = $worker; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trabajador): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>


<?php $__env->startSection('ruta', 'Detalle de trabajador'); ?>
...
<div class="card-block">
    <div class="card-body ">
        ...
        <input type="text" class="form-control" id="basicInput" value="<?php echo e($trabajador->nombre); ?>" readonly="readonly">
    	</fieldset>
    	<fieldset class="form-group col-xl-4 col-lg-6 col-md-12"> Rut:
        <input type="text" class="form-control" id="basicInput" value="<?php echo e($trabajador->rut); ?>" readonly="readonly">
    	</fieldset>
    	<fieldset class="form-group col-xl-4 col-lg-6 col-md-12"> Cargo:
        <input type="text" class="form-control" id="basicInput" value="<?php echo e($trabajador->cargo); ?>" readonly="readonly">
    	</fieldset>
    	<fieldset class="form-group col-xl-4 col-lg-6 col-md-12"> Actividades:
        <input type="text" class="form-control" id="basicInput" value="<?php echo e($trabajador->actividades); ?>" readonly="readonly">
    	</fieldset>
    	<fieldset class="form-group col-xl-4 col-lg-6 col-md-12"> Empresa:
        <input type="text" class="form-control" id="basicInput" value="<?php echo e($trabajador->empresa_id); ?>" readonly="readonly">
    	</fieldset>
        <fieldset class="form-group col-xl-4 col-lg-6 col-md-12"> 
    	<a href="<?php echo e(url('/trabajadores/'.$trabajador->empresa_id)); ?>"><button type="button" class="btn btn-light btn-min-width mr-1 mb-1">Volver</button></a>
        </fieldset>
    </div>
</div>
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form method="POST" action="<?php echo e(URL('trabajadores/update/'.$trabajador->id)); ?>">
                <?php echo e(csrf_field()); ?>

                <?php echo e(method_field('PUT')); ?>

                <fieldset class="form-group col-xl-4 col-lg-6 col-md-12"> Nombres:
                <input type="text" class="form-control" id="nombre" name="nombre" value="<?php echo e($trabajador->nombre); ?>" >
                </fieldset>
                <fieldset class="form-group col-xl-4 col-lg-6 col-md-12"> Rut:
                <input type="text" class="form-control" id="rut" name="rut" value="<?php echo e($trabajador->rut); ?>">
                </fieldset>
                <fieldset class="form-group col-xl-4 col-lg-6 col-md-12"> Cargo:
                <input type="text" class="form-control" id="cargo" name="cargo" value="<?php echo e($trabajador->cargo); ?>" >
                </fieldset>
                <fieldset class="form-group col-xl-4 col-lg-6 col-md-12"> Actividades:
                <input type="text" class="form-control" id="actividades" name="actividades" value="<?php echo e($trabajador->actividades); ?>">
                </fieldset>
                <fieldset class="form-group col-xl-4 col-lg-6 col-md-12"> Empresa:
                <input type="text" class="form-control" id="empresa" name="empresa" value="<?php echo e($trabajador->empresa_id); ?>" readonly="readonly" >
                </fieldset>            
          </div>
    ...
    <div class="modal fade" id="modaldoc" tabindex="-1" role="dialog" aria-labelledby="modaldoc" aria-hidden="true">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form method="POST" action="<?php echo e(URL('/documentos')); ?>" enctype="multipart/form-data">
            <?php echo e(csrf_field()); ?>
            ...
            <input type="hidden" name="dato" id="dato" value="<?php echo e($trabajador->rut); ?>">                    
          </div>
          <div class="modal-footer">   
            <button type="summit" class="btn btn-success">Guardar</button>
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                        ...
                        <div class="modal fade" id="exampleModal<?php echo e($loop->index); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <embed src="<?php echo e(asset("storage/$documento->actividad")); ?>" type="application/pdf" width="770px" height="500px" />
                              </div>
                              <div class="modal-footer">
                    ...
                    <td><?php echo e($documento->observaciones); ?></td> 
                     ...
                     <td>
                        <div class="fonticon-container">
                            ...
                            <div class="fonticon-container">
                            <form method="POST" action="<?php echo e(URL('/trabajadores/delete')); ?>" id="eliminar">
                                <?php echo e(csrf_field()); ?>
                      ...
                      <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form method="POST" action="<?php echo e(URL('/trabajadores/docs')); ?>" enctype="multipart/form-data">
                            <?php echo e(csrf_field()); ?>
                            ...
                            <input type="hidden" name="dato" id="dato" value="<?php echo e($trabajador->id); ?>"> 
                            <input type="hidden" name="documento" id="documento" value="<?php echo e($documento->id); ?>"> 
                            <input type="hidden" name="data" id="data" value="<?php echo e($trabajador->empresa_id); ?>">                
                          </div>
                          <div class="modal-footer">   
                            <button type="summit" class="btn btn-success">Guardar</button>
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\enlace\resources\views/workers/details.blade.php ENDPATH**/ ?>