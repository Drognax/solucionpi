...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <body class="vertical-layout vertical-menu 2-columns   menu-expanded fixed-navbar" data-open="click" data-menu="vertical-menu" data-color="bg-chartbg" data-col="2-columns">
   ...
   <nav class="header-navbar navbar-expand-md navbar navbar-with-menu navbar-without-dd-arrow fixed-top navbar-semi-light">
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true" data-img="<?php echo e(URL::asset('theme-assets/images/backgrounds/02.jpg')); ?>">
      <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">       
          <li class="nav-item mr-auto"><a class="navbar-brand" href="<?php echo e(url ('/')); ?>"><img class="brand-logo" alt="Enlace Prevención Logo" src="<?php echo e(URL::asset('../theme-assets/images/logo/logo.png')); ?>"/>
              <h4 class="brand-text">Administrador</h4></a></li>
      ...
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class="nav-item"><a href="<?php echo e(url ('/')); ?>"><i class="ft-home"></i><span class="menu-title" data-i18n="">Inicio</span></a>
          </li>
          <li class=" nav-item"><a href="<?php echo e(url('/empresas')); ?>"><i class="la la-building"></i><span class="menu-title" data-i18n="">Empresas</span></a>
          </li>
          <li class=" nav-item"><a href="<?php echo e(url('/usuarios')); ?>"><i class="la la-users"></i><span class="menu-title" data-i18n="">Usuarios</span></a>
          </li>
          <li class=" nav-item"><a href="<?php echo e(url('/perfil')); ?>"><i class="la la-user-secret"></i><span class="menu-title" data-i18n="">Perfil</span></a>
          </li>
          <li class=" nav-item"><a href="#"><i class="ft-box"></i><span class="menu-title" data-i18n="">CPanel</span></a>
          </li>
          <li class=" nav-item"><a href="<?php echo e(url('/logout')); ?>"><i class="la la-times-circle"></i><span class="menu-title" data-i18n="">Logout</span></a>
          </li>
...
</html><?php /**PATH D:\laragon\www\enlace\resources\views/layout.blade.php ENDPATH**/ ?>