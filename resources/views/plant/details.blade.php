@extends('layout')
@foreach ($plant as $local)
@endforeach


@section('ruta', 'Detalle de la Instalación')
...
<div class="card-block">
    <div class="card-body ">
        ...
        <div class="btn-group mr-1 mb-1">
            ...
            <fieldset class="form-group col-xl-4 col-lg-6 col-md-12"> Faena:
            <input type="text" class="form-control" id="faena" name="faena" value="{{$local->faena}}" readonly="readonly">
        	</fieldset>
        	<fieldset class="form-group col-xl-4 col-lg-6 col-md-12"> Direccion:
            <input type="text" class="form-control" id="direccion" name="direccion" value="{{$local->direccion}}" readonly="readonly">
        	</fieldset>
        	<fieldset class="form-group col-xl-4 col-lg-6 col-md-12"> Area:
            <input type="text" class="form-control" id="area" name="area" value="{{$local->area}}" readonly="readonly">
        	</fieldset>
        	<fieldset class="form-group col-xl-4 col-lg-6 col-md-12"> Actividades:
            <input type="text" class="form-control" id="actividades" name="actividades" value="{{$local->actividades}}" readonly="readonly">
        	</fieldset>
        	<fieldset class="form-group col-xl-4 col-lg-6 col-md-12"> Empresa:
            <input type="text" class="form-control" id="id" name="id" value="{{$local->empresa_id}}" readonly="readonly">
        	</fieldset>
            <fieldset class="form-group col-xl-4 col-lg-6 col-md-12"> 
        	<a href="{{ url('/instalaciones/'.$local->empresa_id) }}"><button type="button" class="btn btn-light btn-min-width mr-1 mb-1">Volver</button></a>
            </fieldset>
    </div>
</div>
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form method="POST" action="{{URL('instalaciones/update/'.$local->id)}}">
                {{ csrf_field() }}
                {{method_field('PUT')}}
                <fieldset class="form-group col-xl-4 col-lg-6 col-md-12"> Faena:
                <input type="text" class="form-control" id="faena" name="faena" value="{{$local->faena}}" >
                </fieldset>
                <fieldset class="form-group col-xl-4 col-lg-6 col-md-12"> Direccion:
                <input type="text" class="form-control" id="direccion" name="direccion" value="{{$local->direccion}}">
                </fieldset>
                <fieldset class="form-group col-xl-4 col-lg-6 col-md-12"> Area:
                <input type="text" class="form-control" id="area" name="area" value="{{$local->area}}" >
                </fieldset>
                <fieldset class="form-group col-xl-4 col-lg-6 col-md-12"> Actividades:
                <input type="text" class="form-control" id="actividades" name="actividades" value="{{$local->actividades}}">
                </fieldset>
                <fieldset class="form-group col-xl-4 col-lg-6 col-md-12"> Empresa:
                <input type="text" class="form-control" id="empresa" name="empresa" value="{{$local->empresa_id}}" readonly="readonly" >
                </fieldset>            
          </div>
    ...
    <div class="modal fade" id="modaldoc" tabindex="-1" role="dialog" aria-labelledby="modaldoc" aria-hidden="true">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form method="POST" action="{{URL('/documentPlant')}}" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <input type="hidden" name="dato" id="dato" value="{{$local->id}}">                    
          </div>
          <div class="modal-footer">   
            <button type="summit" class="btn btn-success">Guardar</button>
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                ...
                <tr>
                    ...
                    <td>
                        <div class="fonticon-container">
                            ...
                            <div class="fonticon-container">
                            <form method="POST" action="{{URL('/instalaciones/delete')}}" id="eliminar">
                                {{ csrf_field() }}
                                {{method_field('PUT')}}
                      ...
                      <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form method="POST" action="{{URL('/instalaciones/docs')}}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{method_field('PUT')}}
                            ...
                            <input type="hidden" name="data" id="data" value="{{$local->empresa_id}}">                
                          </div>
                          <div class="modal-footer">   
                            <button type="summit" class="btn btn-success">Guardar</button>
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
