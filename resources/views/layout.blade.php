    ...
    <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true" data-img="{{{URL::asset('theme-assets/images/backgrounds/02.jpg')}}}">
      <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">       
          <li class="nav-item mr-auto"><a class="navbar-brand" href="{{url ('/')}}"><img class="brand-logo" alt="Enlace Prevención Logo" src="{{{URL::asset('../theme-assets/images/logo/logo.png')}}}"/>
      ...
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class="nav-item"><a href="{{url ('/')}}"><i class="ft-home"></i><span class="menu-title" data-i18n="">Inicio</span></a>
          </li>
          <li class=" nav-item"><a href="{{ url('/empresas') }}"><i class="la la-building"></i><span class="menu-title" data-i18n="">Empresas</span></a>
          </li>
          <li class=" nav-item"><a href="{{ url('/usuarios') }}"><i class="la la-users"></i><span class="menu-title" data-i18n="">Usuarios</span></a>
          </li>
