...
@section('ruta', 'Detalle de Equipamento')
...
<div class="card-block">
    <div class="card-body ">
        ...
        <div class="btn-group mr-1 mb-1">
            ...
            <input type="text" class="form-control" id="nombre" name="nombre" value="{{$equipo->nombre}}" readonly="readonly">
        	</fieldset>
        	<fieldset class="form-group col-xl-4 col-lg-6 col-md-12"> Referencia:
            <input type="text" class="form-control" id="referencia" name="referencia" value="{{$equipo->referencia}}" readonly="readonly">
        	</fieldset>
        	<fieldset class="form-group col-xl-4 col-lg-6 col-md-12"> Modelo:
            <input type="text" class="form-control" id="modelo" name="modelo" value="{{$equipo->modelo}}" readonly="readonly">
        	</fieldset>
        	<fieldset class="form-group col-xl-4 col-lg-6 col-md-12"> Marca:
            <input type="text" class="form-control" id="marca" name="marca" value="{{$equipo->marca}}" readonly="readonly">
        	</fieldset>
        	<fieldset class="form-group col-xl-4 col-lg-6 col-md-12"> Empresa:
            <input type="text" class="form-control" id="id" name="id" value="{{$equipo->empresa_id}}" readonly="readonly">
        	</fieldset>
            <fieldset class="form-group col-xl-4 col-lg-6 col-md-12"> 
        	<a href="{{ url('/equipamento/'.$equipo->empresa_id) }}"><button type="button" class="btn btn-light btn-min-width mr-1 mb-1">Volver</button></a>
            </fieldset>
    </div>
</div>
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form method="POST" action="{{URL('equipamento/update/'.$equipo->id)}}">
                {{ csrf_field() }}
                {{method_field('PUT')}}
                <fieldset class="form-group col-xl-4 col-lg-6 col-md-12"> Nombres:
                ...
                <input type="text" class="form-control" id="referencia" name="referencia" value="{{$equipo->referencia}}">
                </fieldset>
                ...
                <fieldset class="form-group col-xl-4 col-lg-6 col-md-12"> Empresa:
                <input type="text" class="form-control" id="empresa" name="empresa" value="{{$equipo->empresa_id}}" readonly="readonly" >
                </fieldset>            
          </div>
    ...
    <div class="modal fade" id="modaldoc" tabindex="-1" role="dialog" aria-labelledby="modaldoc" aria-hidden="true">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form method="POST" action="{{URL('/documentosEquip')}}" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <input type="hidden" name="dato" id="dato" value="{{$equipo->id}}">                    
          </div>
          <div class="modal-footer">   
            <button type="summit" class="btn btn-success">Guardar</button>
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                ...
                <tr>
                        ...
                        <div class="modal fade" id="exampleModal{{$loop->index}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <embed src="{{asset("storage/$documento->actividad") }}" type="application/pdf" width="100%" height="500px" />
                              </div>
                              <div class="modal-footer">
                    ...
                    <td>
                        <div class="fonticon-container">
                            ...
                            <div class="fonticon-container">
                            <form method="POST" action="{{URL('/equipamento/delete')}}" id="eliminar">
                                {{ csrf_field() }}
                                {{method_field('PUT')}}
                      ...
                      <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form method="POST" action="{{URL('/equipamento/docs')}}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{method_field('PUT')}}
                            ...
                            <input type="hidden" name="data" id="data" value="{{$equipo->empresa_id}}">                
                          </div>
                          <div class="modal-footer">   
                            <button type="summit" class="btn btn-success">Guardar</button>
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
