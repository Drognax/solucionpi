  ...
  <body class="vertical-layout fixed-navbar 1-column" data-color="bg-chartbg">
   ...
   <nav class="header-navbar navbar-expand-md fixed-top navbar-semi-light">
    ...
    <!-- ////////////////////////////////////////////////////////////////////////////-->
          ...
          <li class="nav-item"><a href="{{url ('/dashboard')}}"><i class="ft-home"></i><span class="menu-title">Inicio</span></a>
          </li>
          <li class=" nav-item"><a href="{{ url('/miplan') }}"><i class="la la-building"></i>Plan Preventivo</a>
          </li>
          ...
          <li class=" nav-item"><a href="{{ url('/logout') }}"><i class="la la-times-circle"></i><span class="menu-title">Logout</span></a>
          </li>
          </li>
